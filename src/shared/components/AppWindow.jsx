...
export default function AppWindow({title, onClick, onChange, value, children, width = 1100, height = 700}) {
            ...
            <div className="p-3"
                ...
                <div className="flex items-center justify-between px-3 mt-3">
                    ...
                    <div className="flex gap-1 relative">
                        ...
                        <input onChange={onChange} value={value} type="text" className="border border-[#000000] border-opacity-10 rounded w-[300px] px-7"/>
