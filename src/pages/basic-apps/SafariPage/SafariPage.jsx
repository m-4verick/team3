        ...
        <Window>
            <div className="flex justify-between mb-5">
                ...
                <div className="flex gap-1">
                    <input type="text" className="border border-black rounded-xl px-2 py-1 w-[300px]"/>
                    <button className="bg-gray-700 rounded-xl text-white px-2 py-1">검색</button>
                </div>
                <div className="flex gap-5">
                    <button className="bg-gray-700 rounded-xl text-white px-2 py-1">+ 만들기</button>
