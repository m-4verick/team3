        ...
        <div className="mt-4 mb-4">
          ...
          <div className="flex flex-col gap-4">
            <p>
              ...
              삶을 준비하고 있는 김민희라고 합니다. 아주 어렸을 때는 막연히
              나중에 크면 컴퓨터 관련 일을 하지 않을까라는 생각을 했을 정도로
              관심이 많았었는데, 어찌 돌고 돌아 이제야 시작해보네요!
            </p>
            <p>
            ...
            <p>
              ...
              기분과 개발에서 코드 에러가 떠서 디버깅해야 할 때의 기분이 비슷한
              것 같습니다...ㅋ 중요한 얘기는 아닌데 그냥 얘기해보고 싶었어요;;
            </p>
            <p>
